...
<?php if($d1=Session::get('date1') and $d2=Session::get('date2')): ?>
    ...
    <div class="panel-heading">
        <h2 class="panel-title mb-5 font-weight-bold text-center" align="center"> Rapport de payement périodique <br> Agence <?php echo e($a->adresse); ?> </h2>
       ...
       <?php else: ?>
        ...
        <br>
    <div class="panel-heading">
       <h2 class="panel-title mb-5 font-weight-bold" align="center"> Rapport de payement journalier<br> Agence <?php echo e($a->adresse); ?> </h2>
    </div>
       <?php endif; ?>
