			...
			<div class="col-12">
				<table class="table">
					<tr>
						...
						<td class="text-right font-weight-bold"><h5 class="align-rigth">Le <?php echo e($d); ?> <br> à <?php echo e($t); ?> </h5></td>
					</tr>
				</table>
				...
				<table class="font-weight-bold" style="font-size: 15px;">
					<tr> <td class="font-weight-light""> Le bénéficiaire : </td> <td> <?php echo e($data->matOrph); ?>  </td> </tr>
					<tr> <td class="font-weight-light"> sous le tuteur de : </td> <td> <?php echo e($data->prenomTuteur); ?> <?php echo e($data->nomTuteur); ?> </td> </tr>
					<tr> <td class="font-weight-light"> a reçu un montant de : </td> <td> <?php echo e($data->montant); ?> Franc CFA  </td> </tr>
					<tr> <td class="font-weight-light"> Prénom et nom du caissier : </td> <td> <?php echo e($a->prenom); ?> <?php echo e($a->nom); ?> </td> </tr>
					<tr> <td class="font-weight-light"> Agence : </td> <td>  <?php echo e($a->adresse); ?> </td> </tr>
					
					<tr> <td>  </td> </tr>
					<tr> <td></td> <td></td> <td class="font-weight-light text-right mt-4"> Piéce d'identité : </td> <td class="mt-4">  <?php echo e($carte); ?> </td> </tr>					
